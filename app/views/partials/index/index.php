            ...
            <div class="container">
                <div class="row ">
                        ...
                        <div class="">
                            <div class="fadeIn animated mb-4">
                                <div class="text-capitalize">
                                    <h3 class="custom-1">SELAMAT DATANG CALON SISWA SD NEGERI 1 WATUGEDE</h3>
                                    <h4 class="custom-1">Tahun Pelajaran 2022 - 2023</h4> <hr>
                                    <p class="">Sebelum Melanjutkan Pengisian Data Siswa</p>
                                    <p class="">Silakan untuk register / daftar</p>
                                    <p class="">Setelah register / daftar akan di arahkan ke halaman pengisian data siswa</p>
                                    <p><strong>Apabila ada kesulitan bisa meminta bantuan sekolah</strong></p>
                                    <p class=""> <a href="<?php print_link("info/help") ?>" class="badge badge-primary">Pusat Bantuan</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 comp-grid">
                        ...
                        <div  class="background: rgb(131,58,180) p-3 animated fadeIn page-content">
                            <div>
                                ...
                                <form name="loginForm" action="<?php print_link('index/login/?csrf_token=' . Csrf::$token); ?>" class="needs-validation form page-form" method="post">
                                    ...
                                    <div class="text-center">
                                        Silakan Daftar di sini <a href="<?php print_link("index/register") ?>" class="btn btn-success rounded">Daftar
                                        </a>
                                    </div>
                                </form>
                            </div>
