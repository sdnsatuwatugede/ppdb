...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    if( $show_header == true ){
    ?>
    <div  class="background: linear-gradient(90deg, #00C9FF 0%, #92FE9D 100%) my-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><div class="custom-2">FORMULIR ppdb siswa</div>
                        <hr/>
                        <style>
                            .custom-2 {
                            font-weight: bold;
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <div id="ctrl-no_pendaftaran-holder" class=""> 
                                            <input id="ctrl-no_pendaftaran"  value="<?php  echo $this->set_field_value('no_pendaftaran',random_num(3)); ?>" type="text" placeholder="Enter No Pendaftaran"  readonly required="" name="no_pendaftaran"  class="form-control " />
                                            </div>
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <div class="form-group col-md-6">
                                                                        ...
                                                                        <div id="ctrl-no_reg_akte-holder" class=""> 
                                                                            <input id="ctrl-no_reg_akte"  value="<?php  echo $this->set_field_value('no_reg_akte',""); ?>" type="text" placeholder="No Register Akte"  required="" name="no_reg_akte"  class="form-control " />
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group col-md-6">
                                                                            ...
                                                                            <div id="ctrl-kewarga-holder" class=""> 
                                                                                ...
                                                                                $label = $option['label'];
                                                                                //check if current option is checked option
                                                                                $checked = $this->set_field_checked('kewarga', $value, "");
                                                                                ?>
                                                                                <label class="custom-control custom-radio custom-control-inline">
                                                                            ...
                                                                            <div class="form-group col-md-6">
                                                                                ...
                                                                                <div id="ctrl-alamat-holder" class=""> 
                                                                                    <textarea placeholder="Alamat" id="ctrl-alamat"  required="" rows="3" name="alamat" class=" form-control"><?php  echo $this->set_field_value('alamat',""); ?></textarea>
                                                                            ...
                                                                            <div class="form-group col-md-3">
                                                                                ...
                                                                                <div id="ctrl-rt-holder" class=""> 
                                                                                    <input id="ctrl-rt"  value="<?php  echo $this->set_field_value('rt',""); ?>" type="number" placeholder="RT" step="1"  required="" name="rt"  class="form-control " />
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group col-md-3">
                                                                                    ...
                                                                                    <div class="form-group col-md-6">
                                                                                        ...
                                                                                        <div class="form-group col-md-6">
                                                                                            ...
                                                                                            <div id="ctrl-kelurahan-holder" class=""> 
                                                                                                <input id="ctrl-kelurahan"  value="<?php  echo $this->set_field_value('kelurahan',""); ?>" type="text" placeholder="Kelurahan / Desa"  required="" name="kelurahan"  class="form-control " />
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="form-group col-md-6">
                                                                                                <label class="control-label" for="kec">Kecamatan <span class="text-danger">*</span></label>
                                                                                                <div id="ctrl-kec-holder" class=""> 
                                                                                                    <input id="ctrl-kec"  value="<?php  echo $this->set_field_value('kec',"Singosari"); ?>" type="text" placeholder="Kecamatan"  required="" name="kec"  class="form-control " />
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="form-group col-md-6">
                                                                                                    <label class="control-label" for="kd_pos">Kode Pos <span class="text-danger">*</span></label>
                                                                                                    <div id="ctrl-kd_pos-holder" class=""> 
                                                                                                        <input id="ctrl-kd_pos"  value="<?php  echo $this->set_field_value('kd_pos',"65153"); ?>" type="number" placeholder="Kode Pos" step="1"  required="" name="kd_pos"  class="form-control " />
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div class="form-group col-md-6">
                                                                                                    ...
                                                                                                    <div class="form-group col-md-6">
                                                                                                        ...
                                                                                                        <div id="ctrl-anak_ke-holder" class=""> 
                                                                                                            <input id="ctrl-anak_ke"  value="<?php  echo $this->set_field_value('anak_ke',""); ?>" type="number" placeholder="Anak Ke" step="1"  required="" name="anak_ke"  class="form-control " />
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div class="form-group col-md-6">
                                                                                                                    ...
                                                                                                                    <div class="form-group col">
                                                                                                                        ...
                                                                                                                        <div class="form-group col-md-6">
                                                                                                                            ...
                                                                                                                            <div id="ctrl-no_telp-holder" class=""> 
                                                                                                                                <input id="ctrl-no_telp"  value="<?php  echo $this->set_field_value('no_telp',""); ?>" type="tel" placeholder="Enter Nomer Telphone"  required="" name="no_telp"  class="form-control " />
                                                                                                                                </div>
                                                                                                                                <small class="form-text">No Telp Rumah kalau ada / kalau tidak ada isi dengan no hp</small>
                                                                                                                            </div>
                                                                                                                            <div class="form-group col-md-6">
                                                                                                                                <label class="control-label" for="no_hp">Nomer Hp <span class="text-danger">*</span></label>
                                                                                                                                <div id="ctrl-no_hp-holder" class=""> 
                                                                                                                                    <input id="ctrl-no_hp"  value="<?php  echo $this->set_field_value('no_hp',""); ?>" type="tel" placeholder="Enter Nomer Hp"  required="" name="no_hp"  class="form-control " />
                                                                                                                                    </div>
                                                                                                                                ...
                                                                                                                                <div class="form-group col-md-6">
                                                                                                                                    ...
                                                                                                                                    <div id="ctrl-tinggi_badan-holder" class=""> 
                                                                                                                                        <input id="ctrl-tinggi_badan"  value="<?php  echo $this->set_field_value('tinggi_badan',""); ?>" type="number" placeholder="Tinggi Badan" min="10" max="200" step="1"  required="" name="tinggi_badan"  class="form-control " />
                                                                                                                                        </div>
                                                                                                                                    ...
                                                                                                                                    <div class="form-group col-md-6">
                                                                                                                                        ...
                                                                                                                                        <div id="ctrl-berat_badan-holder" class=""> 
                                                                                                                                            <input id="ctrl-berat_badan"  value="<?php  echo $this->set_field_value('berat_badan',""); ?>" type="number" placeholder="Berat Badan" min="10" max="100" step="1"  required="" name="berat_badan"  class="form-control " />
                                                                                                                                            </div>
                                                                                                                                        ...
                                                                                                                                        <div class="form-group col-md-6">
                                                                                                                                            ...
                                                                                                                                            <div id="ctrl-jarak_rumah-holder" class=""> 
                                                                                                                                                <input id="ctrl-jarak_rumah"  value="<?php  echo $this->set_field_value('jarak_rumah',""); ?>" type="text" placeholder="Jarak Rumah"  required="" name="jarak_rumah"  class="form-control " />
                                                                                                                                                </div>
                                                                                                                                            ...
                                                                                                                                            <div class="form-group col-md-6">
                                                                                                                                                ...
                                                                                                                                                <div id="ctrl-waktu_tempuh-holder" class=""> 
                                                                                                                                                    <input id="ctrl-waktu_tempuh"  value="<?php  echo $this->set_field_value('waktu_tempuh',"15 Menit"); ?>" type="text" placeholder="Waktu Tempuh"  required="" name="waktu_tempuh"  class="form-control " />
                                                                                                                                                    </div>
